...
class CarOwnerTripsHistoryScreen extends StatefulWidget {
  const CarOwnerTripsHistoryScreen({Key? key}) : super(key: key);
  static const routeName = "CarOwnerTripsHistoryScreenPage";
  @override
  State<CarOwnerTripsHistoryScreen> createState() =>
      _CarOwnerTripsHistoryScreenState();
}

class _CarOwnerTripsHistoryScreenState
    extends State<CarOwnerTripsHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          builder: ((context, snapshot) {
            if (snapshot.hasData) {
              ...
              for (int i = 0; i < snapshot.data!.docs.length; i++) {
                ...
                if (data['carOwnerName'] == currentCarOwner!.userName) {
                  historyTrips.add(
                    Trip(
                      data["carOwnerName"],
                      data["carModel"],
                  ...
                  itemBuilder: ((context, index) {
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "Customer Name: ${historyTrips[index].customerName}",
      ...
      bottomNavigationBar:
          carOwnerBottomNavigationBar(context: context, selectedIndex: 2),
    );
  }
}
